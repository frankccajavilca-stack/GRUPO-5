...
const Profile = () => {
  ...
  useEffect(() => {
    if (profile) {
      ...
      console.log('Perfil cargado:', profile); // Debug log
    }
  }, [profile]);
  ...
  const handleSaveChanges = async () => {
    try {
      // El backend requiere photo_url, así que incluimos la URL actual de la foto
      const currentPhotoUrl = profile?.profile_photo_url || photoUrl || '';
      ...
      const updateData = {
        ...
        sex: genero,
        phone: telefono,
        photo_url: currentPhotoUrl, // Incluir la URL actual de la foto (requerido por el backend)
      };

      console.log('Perfil actual:', profile);
      console.log('URL de foto del perfil:', profile?.profile_photo_url);
      console.log('URL de foto del contexto:', photoUrl);
      console.log('URL de foto final:', currentPhotoUrl);
